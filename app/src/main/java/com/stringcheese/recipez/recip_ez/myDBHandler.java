...
public class myDBHandler extends SQLiteOpenHelper {
    ...
    public static final String CREATE_RECIPE_INGREDIENTS_TABLE = "CREATE TABLE IF NOT EXISTS " + RECIPE_INGREDIENTS_TABLE + "(" + COLUMN_RECIPE_ID + " INTEGER, " + COLUMN_INGREDIENT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_RECIPE_INGREDIENTS_AMOUNT  + " INTEGER, " + COLUMN_RECIPE_INGREDIENTS_AMOUNT_MODIFIER + " TEXT );";
